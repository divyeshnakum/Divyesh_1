...
import { baseColorYel, borderColor, hoverColorYel, TextGray } from "../ColorLayout";

const EditProfileModal = ({ isOpen, onClose, onSave, initialData  }) => {
  const [fullName, setFullName] = useState(initialData?.personalInfo.fullName || "");
  ...
  return (
    <div className="fixed inset-0 bg-opacity-40 flex justify-center items-center z-50 p-4">
      <div className={`bg-white border ${borderColor} rounded-2xl w-full max-w-3xl  overflow-hidden`}>
        {/* Header */}
