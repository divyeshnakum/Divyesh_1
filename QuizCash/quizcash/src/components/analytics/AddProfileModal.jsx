...
import { borderColor,baseColorYel,hoverColorYel, bgCartColor } from "../ColorLayout";
...
const AddSubAdminModal = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
      <div className={`w-full p-4 max-w-2xl border ${borderColor} rounded-2xl ${bgCartColor}`}>
...
<div className={`border-t border-b py-3 sm:py-4 md:py-6 lg:py-8 ${borderColor}`}>
        {/* Body */}
        ...
        <div className="flex items-center justify-end gap-4 pt-4">
          ...
          <button className={`px-4 py-2 rounded-md font-semibold ${baseColorYel} ${hoverColorYel}`}>
            Create Sub Admin
          </button>
        </div></div>
    </div>
